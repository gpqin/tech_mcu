/**
 **************************************************************************
 * File Name    : scm4xx_i2c.h
 * Description  : scm4xx I2C header file
 * Date         : 2018-10-08
 * Version      : V1.0.5
 **************************************************************************
 */
...
#ifndef __SCM4xx_I2C_H
#define __SCM4xx_I2C_H
...
#define IS_I2C_ALL_PERIPH(PERIPH)       (((PERIPH) == I2C1) || \
                                         ((PERIPH) == I2C2))
#elif defined (SCM402x) || defined (SCM402xx)
#define IS_I2C_ALL_PERIPH(PERIPH)       (((PERIPH) == I2C1) || \
                                         ((PERIPH) == I2C2) || \
                                         ((PERIPH) == I2C3))
#endif
 ...
 *         library (scm4xx_i2c.h) or to custom values defined by user.
