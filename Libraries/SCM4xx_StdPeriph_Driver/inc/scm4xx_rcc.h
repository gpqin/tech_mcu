/**
 **************************************************************************
 * File Name    : scm4xx_rcc.h
 * Description  : scm4xx RCC header file
 * Date         : 2018-02-26
 * Version      : V1.0.4
 **************************************************************************
 */
...
#ifndef __SCM4xx_RCC_H
#define __SCM4xx_RCC_H
...
#elif defined (SCM402xx)
#define IS_RCC_AHB_PERIPH(PERIPH)   ((((PERIPH) & 0xFFFFFEA8) == 0x00) && ((PERIPH) != 0x00))
...
#elif defined (SCM402xx)
#define IS_RCC_APB2_PERIPH(PERIPH)  ((((PERIPH) & 0xF8878582) == 0x00) && ((PERIPH) != 0x00))
#elif defined (SCM403x)
...
#elif defined (SCM402xx)
#define IS_RCC_APB1_PERIPH(PERIPH)  ((((PERIPH) & 0xE5003600) == 0x00) && ((PERIPH) != 0x00))
#elif defined (SCM403x)
...
/** @defgroup Clock_source_to_output_MCOPRE
  * @{
  */
#define  RCC_MCOPRE                 RCC_MISC_MCOPRE
...
#elif defined (SCM403x) || defined (SCM402xx)
