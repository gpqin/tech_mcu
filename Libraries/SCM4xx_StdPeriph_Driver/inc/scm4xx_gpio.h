/**
 **************************************************************************
 * File Name    : scm4xx_gpio.h
 * Description  : scm4xx GPIO header file
 * Date         : 2018-10-08
 * Version      : V1.0.5
 **************************************************************************
 */
...
#ifndef __SCM4xx_GPIO_H
#define __SCM4xx_GPIO_H
...
#if defined (SCM402x) || defined (SCM403x) || defined (SCM402xx)
...
#define IS_GPIO_REMAP(REMAP)        (((REMAP) == GPIO_Remap01_SPI1)         || ((REMAP) == GPIO_Remap_I2C1)           || \
                                     ...
                                     ((REMAP) == GPIO_Remap_TMR2ITR1)       || ((REMAP) == GPIO_Remap_SPI3)           || \
