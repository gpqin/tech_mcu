/**
 **************************************************************************
 * File Name    : scm4xx_dma.h
 * Description  : scm4xx DMA header file
 * Date         : 2018-02-26
 * Version      : V1.0.4
 **************************************************************************
 */
...
#ifndef __SCM4xx_DMA_H
#define __SCM4xx_DMA_H
...
#elif defined (SCM402xx) || defined (SCM403x)                                             
#define IS_DMA_ALL_PERIPH(PERIPH)           (((PERIPH) == DMA1_Channel1) || \
                                             ((PERIPH) == DMA1_Channel2) || \
                                             ((PERIPH) == DMA1_Channel3) || \
                                             ((PERIPH) == DMA1_Channel4) || \
...
#define IS_DMA_ALL_HARDWARE_ID(HARDWARE_ID)     (((HARDWARE_ID) == DMA_FLEXIBLE_ADC1)     || \
