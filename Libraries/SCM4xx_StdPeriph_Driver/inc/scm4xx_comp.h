/**
  ...
  * @attention
  *
  * <h2><center>&copy; COPYRIGHT 2012 SC</center></h2>
  *
  * Licensed under SC Liberty SW License Agreement V2, (the "License");
...
#ifndef __SCM4XX_COMP_H
#define __SCM4XX_COMP_H
