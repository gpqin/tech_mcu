/**
 **************************************************************************
 * File Name    : scm4xx_pwr.c
 * Description  : scm4xx PWR source file
 * Date         : 2018-02-26
 * Version      : V1.0.4
 **************************************************************************
 */
...
#define CTRLSTS_EWUP_BB             (PERIPH_BB_BASE + (CTRLSTS_OFFSET * 32) + (EWUP_BitNumber * 4))
  ...
  #define EWUP_BitNumber3              0x0A
  #define CTRLSTS_EWUP_BB3             (PERIPH_BB_BASE + (CTRLSTS_OFFSET * 32) + (EWUP_BitNumber3 * 4))

  /* Alias word address of EWUP4 bit */
  #define EWUP_BitNumber4              0x0B
  #define CTRLSTS_EWUP_BB4             (PERIPH_BB_BASE + (CTRLSTS_OFFSET * 32) + (EWUP_BitNumber4 * 4))
#endif
...
/**
  * @brief  Enables or disables the WakeUp Pin3 functionality.
  * @param  NewState: new state of the WakeUp Pin3 functionality.
  *   This parameter can be: ENABLE or DISABLE.
  * @retval None
  */
void PWR_WakeUpPinCtrl3(FunctionalState NewState)
{
  GPIO_InitType GPIO_InitStructure;
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
  ...
  *(__IO uint32_t *) CTRLSTS_EWUP_BB3 = (uint32_t)NewState;
}

/**
  * @brief  Enables or disables the WakeUp Pin4 functionality.
  * @param  NewState: new state of the WakeUp Pin4 functionality.
  *   This parameter can be: ENABLE or DISABLE.
  * @retval None
  */
void PWR_WakeUpPinCtrl4(FunctionalState NewState)
{
  GPIO_InitType GPIO_InitStructure;
  /* Check the parameters */
  assert_param(IS_FUNCTIONAL_STATE(NewState));
  ...
  *(__IO uint32_t *) CTRLSTS_EWUP_BB4 = (uint32_t)NewState;
}
#endif
