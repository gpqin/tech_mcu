/**
 **************************************************************************
 * File Name    : scm4xx_flash.c
 * Description  : scm4xx FMC source file
 * Date         : 2018-10-08
 * Version      : V1.0.5
 **************************************************************************
 */
...
#define RDPRT_LV2_Key               ((uint16_t)0x00CC)
...
#define IS_RDP_LV0()               (FLASH_GetRdpLv() == E_RDP_LV0)
#define IS_RDP_LEVEL(LV)           (((LV) == E_RDP_LV0) || ((LV) == E_RDP_LV1) || \
                                    ((LV) == E_RDP_LV2))
...
/**
  ...
  * @note   This function can be used for all scm4xx devices.
  *         - For SCM4xx XL-Density devices this function unlocks Bank1 and Bank2.
...
/**
  ...
  * @note   This function can be used for all scm4xx devices.
  *         - For SCM4xx XL-Density devices this function unlocks Bank1.
...
/**
  ...
  * @note   This function can be used only for SCM4xx XL-Density devices.
  * @param  None
  * @retval None
  */
...
/**
  ...
  * @note   This function can not be used for SCM403x devices.
  * @param  None
  * @retval None
  */
...
/**
  ...
  * @note   This function can be used for all scm4xx devices.
  *         - For SCM4xx XL-Density devices this function Locks Bank1 and Bank2.
...
/**
  ...
  * @note   this function can be used for all scm4xx devices.
  *         - For SCM4xx XL-Density devices this function Locks Bank1.
  *         - For all other devices it Locks Bank1 and it is equivalent
...
/**
  ...
  * @note   This function can be used for all scm4xx devices.
  *         - For SCM4xx XL-Density devices this function erases all Bank1 pages.
...
/**
  ...
  *     @arg For @b SCM4xx High-density_devices: value between FLASH_WRPRT_PAGE_0to1 and
  *       FLASH_WRPRT_PAGE_60to61 or FLASH_WRPRT_PAGE_62to255
  *     @arg For @b SCM4xx XL-density_devices: value between FLASH_WRPRT_PAGE_0to1 and
...
/**
  ...
  * @note   This function can be used only for scm403_XL density devices.
...
/**
  ...
  * @note   This function can be used for all scm4xx devices.
  *         - For SCM4xx XL-Density devices, enables or disables the specified FLASH interrupts
              for Bank1 and Bank2.
...
/**
  ...
  * @note   This function can be used for all scm4xx devices.
  *         - For SCM4xx XL-Density devices, this function checks whether the specified
...
/**
  ...
  * @note   This function can be used for all scm4xx devices.
  *         - For SCM4xx XL-Density devices, this function clears Bank1 or Bank2 pending flags
...
/**
  ...
  * @note   This function can be used for all scm4xx devices, it is equivalent
...
/**
  ...
  * @note   This function can be used for scm4xx XL-Density devices.
  * @param  None
  * @retval FLASH Status: The returned value can be: FLASH_BSY, FLASH_PGRM_FLR,
  *        FLASH_WRPRT_FLR or FLASH_PRC_DONE
  */
...
/**
  ...
  * @note   This function can not be used for SCM403x devices, it is equivalent
  *         to FLASH_GetStatus function.
  * @param  None
  * @retval FLASH Status: The returned value can be: FLASH_BSY, FLASH_PGRM_FLR,
  *         FLASH_WRPRT_FLR or FLASH_PRC_DONE
...
/**
  ...
  *         - For SCM4xx XL-Density devices this function waits for a Bank1 Flash process
...
/**
  ...
  * @note   This function can be used only for SCM403x device.
  * @param  None
  * @retval FLASH Status: The returned value can be: FLASH_BSY, FLASH_PGRM_FLR,
  *         FLASH_WRPRT_FLR, FLASH_PRC_DONE or FLASH_TIMEOUT.
  */
...
#if defined (SCM403x)
/**
  * @brief  Get the current FLASH Read Out Protection Level.
  * @note   This function can be used only for SCM403x device.
  * @param  None
  * @retval FLASH Read Out Protection Level: The returned value can be: E_RDP_LV0, E_RDP_LV1, E_RDP_LV2.
  */
FLASH_RdpLv FLASH_GetRdpLv(void)
{
  FLASH_RdpLv tRdpLv = E_RDP_LV0;
  if ((FLASH->UOB & FLASH_UOB_RDPRTEN) != (uint32_t)RESET)
  {
    if ((FLASH->UOB & FLASH_UOB_RDPRT_HL) != (uint32_t)RESET)
    {
      tRdpLv = E_RDP_LV2;
    }
    else
...
#if defined (SCM403x)
/**
  * @brief  Configure the FLASH Read Out Protection Level.
  * @note   If the user has already programmed the other option bytes before calling
  *         this function, he must re-program them since this function erases all option bytes.
  * @note   This function can be used only for SCM403x device.
  * @param  tNewRdpLv: new level of the FLASH Read Out Protection.
  *         This parameter can be: E_RDP_LV0, E_RDP_LV1, E_RDP_LV2.
  * @retval FLASH Status: The returned value can be: FLASH_BSY, FLASH_PGRM_FLR,
  *         FLASH_WRPRT_FLR, FLASH_PRC_DONE or FLASH_TIMEOUT.
  */
FLASH_Status FLASH_RdpLvSet(FLASH_RdpLv tNewRdpLv)
{
  ...
  assert_param(IS_RDP_LEVEL(tNewRdpLv));
  assert_param(FLASH_GetRdpLv() != E_RDP_LV2);
  status = FLASH_WaitForProcess(ERS_TIMEOUT);
...
#if defined (SCM403x)
/**
  * @brief  Disable the FLASH Read Out Protection Level (RDP level 2 to RDP level 1)
  * @note   This function can be used only for SCM403x device.
  * @param  None
  * @retval None
  */
void FLASH_RdpLv2Disable(void)
{
  ...
  if (FLASH_GetRdpLv() != E_RDP_LV2) 
  {
    /* Not RDP level 2 */
    return;
  }
  FLASH->CTRL |= FLASH_CTRL_RDPL2_DIS_TRIG;
