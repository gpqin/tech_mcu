 ...
 **************************************************************************
 * File Name    : scm4xx.h
 * Description  : scm4xx peripheral access layer header file
 * Date         : 2018-02-26
 * Version      : V1.0.4
 **************************************************************************
 */
...
/* Uncomment the line below according to the target SCM device used in your
   application
  */
#if !defined (SCM402F) && !defined (SCM402P) && \
    !defined (SCM402L) && !defined (SCM403C) && \
    !defined (SCM402FA)&& !defined (SCM402FB)&& \
    !defined (SCM402GA)&& !defined (SCM402HA)
/* #define SCM402L */   /*!< SCM402L: QFN48, XL-density devices: SCM402L */
/* #define SCM402F */   /*!< SCM402F: LQFP100, XL-density devices: SCM402F */
/* #define SCM402FA */  /*!< SCM402FA: LQFP100, XL-density devices: SCM402FA */
/* #define SCM402HA */  /*!< SCM402HA: QFN48, XL-density devices: SCM402HA */
/* #define SCM402FB */  /*!< SCM402FB: LQFP100, XL-density devices: SCM402FB */
/* #define SCM402P */   /*!< SCM402P: LQFP144, XL-density devices: SCM402P */
/* #define SCM403C */   /*!< SCM403C: LQFP48, High density devices: SCM403C */
/* #define SCM402GA */  /*!< SCM402GA: LQFP128, XL-density devices: SCM402GA */
#endif
/*  Tip: To avoid modifying this file each time you need to switch between these
        devices, you can define the device in your toolchain compiler preprocessor.

 - Medium-density devices are scm4xx microcontrollers where
   the Flash memory density ranges between 64 and 128 Kbytes.
 - High-density devices are scm4xx microcontrollers where
   the Flash memory density ranges between 256 and 512 Kbytes.
 - XL-density devices are scm4xx microcontrollers where
   the Flash memory density ranges between 512 and 1024 Kbytes.
  */

#if !defined (SCM402F) && !defined (SCM403C) && \
    !defined (SCM402L) && !defined (SCM402P) && \
    !defined (SCM402FA)&& !defined (SCM402FB)&& \
    !defined (SCM402GA)&& !defined (SCM402HA)
#error "Please select first the target scm4xx device used in your application (in scm4xx.h file)"
#endif

#if defined (SCM402F) || defined (SCM402L) || \
    defined (SCM402P)
    
    #define SCM402x
#endif

#if defined (SCM402FA)|| defined (SCM402FB)|| \
    defined (SCM402GA)|| defined (SCM402HA)
...
/**
 * @brief scm4xx Standard Peripheral Library version number
   */
#define __SCM4xx_LIBRARY_VERSION_MAIN     (0x01) /*!< [31:24] main version */
#define __SCM4xx_LIBRARY_VERSION_MIDDLE   (0x00) /*!< [23:16] middle version */
#define __SCM4xx_LIBRARY_VERSION_MINOR    (0x01) /*!< [15:8]  minor version */
#define __SCM4xx_LIBRARY_VERSION_RC       (0x00) /*!< [7:0]  release candidate */
#define __SCM4xx_LIBRARY_VERSION          ( (__SCM4xx_LIBRARY_VERSION_MAIN << 24)\
                                             |(__SCM4xx_LIBRARY_VERSION_MIDDLE << 16)\
                                             |(__SCM4xx_LIBRARY_VERSION_MINOR << 8)\
                                             |(__SCM4xx_LIBRARY_VERSION_RC))
...
#define __MPU_PRESENT             0     /*!< SCM devices do not provide an MPU           */
#define __NVIC_PRIO_BITS          4     /*!< SCM uses 4 Bits for the Priority Levels     */
#define __Vendor_SysTickConfig    0     /*!< Set to 1 if different SysTick Config is used */
#define __FPU_PRESENT             1U    /*!< FPU present                                  */

/**
 * @brief scm4xx Interrupt Number Definition, according to the selected device
...
typedef enum IRQn
{
    ...
    /******  SCM specific Interrupt Numbers *********************************************************/
...
#endif /* SCM402FA || SCM402FB || SCM402GA || SCM402HA */
...
/** scm4xx Standard Peripheral Library old types (maintained for legacy purpose) */
typedef int32_t  s32;
typedef int16_t  s16;
typedef int8_t   s8;
...
/** scm4xx Standard Peripheral Library old definitions (maintained for legacy purpose) */
...
#if defined (SCM403x) || defined (SCM402xx)
...
#if defined (SCM402F) || defined (SCM402P) || defined (SCM402xx)
#define  RCC_APB1RST_SPI4RST                    ((uint32_t)0x00010000)        /*!< SPI 4 reset */
#endif /* SCM402F || SCM402P || SCM402xx */
...
#if !defined (SCM402L) && !defined (SCM402xx)
...
#define  RCC_MISC_MCOPRE                        ((uint32_t)0xF0000000)        /*!< MCO Div Configure */
...
#define  FLASH_CTRL_RDPL2_DIS_TRIG              ((uint32_t)0x00010000)        /*!< Disable RDP level 2 */
...
#define  FLASH_UOB_RDPRT_HL                     ((uint32_t)0x04000000)        /*!< Read protection high level */
