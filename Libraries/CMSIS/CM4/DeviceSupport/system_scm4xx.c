...
/** @addtogroup scm4xx_System_Private_Includes
  * @{
  */
...
/** @addtogroup scm4xx_System_Private_TypesDefinitions
  * @{
  */
...
/** @addtogroup scm4xx_System_Private_Defines
  * @{
  */
...
/*!< Uncomment the line corresponding to the desired System clock (SYSCLK)
   ...
   4. The System clock configuration functions provided within this file assume that:
        - For scm4xx devices, an external 8MHz crystal is used to drive the System clock.
...
#if defined (SCM402x) || defined (SCM403x) || \
    defined (SCM402xx)
...
/* #define SYSCLK_FREQ_180MHz_HSI   180000000 */
#endif
...
/*!< Uncomment the following line if you need to use external SRAM mounted
     (SCM High density and XL-density devices) as data memory */
...
/** @addtogroup scm4xx_System_Private_Macros
  * @{
  */
...
/** @addtogroup scm4xx_System_Private_Variables
  * @{
  */
...
#elif defined SYSCLK_FREQ_180MHz_HSI
uint32_t SystemCoreClock         = SYSCLK_FREQ_180MHz_HSI;    /*!< System Clock Frequency (Core Clock) */
...
/** @addtogroup scm4xx_System_Private_FunctionPrototypes
  * @{
  */
...
#elif defined SYSCLK_FREQ_180MHz
static void SetSysClockTo180M(void);
#elif defined SYSCLK_FREQ_192MHz
...
#elif defined SYSCLK_FREQ_180MHz_HSI
static void SetSysClockTo180MHSI(void);
#elif defined SYSCLK_FREQ_192MHz_HSI
...
/** @addtogroup scm4xx_System_Private_Functions
  * @{
  */
#if defined (SCM402FB)
/**
  * @brief  Init the bank3 flash of SCM402FB
  * @note   This function can be used only for SCM402FB device.
  * @param  None
  * @retval None
  */
void FLASH_InitBank3(void)
{  
  /* Enable AFIO clock */
  BIT_SET(RCC->APB2EN,RCC_APB2PERIPH_AFIO);
  /* Configure Bank3 AFIO */
  AFIO->MAP2 &= ~(GPIO_Remap_EXT_FLASH & 0x003FFFFF);
  AFIO->MAP2 |= (GPIO_Remap_EXT_FLASH & 0x003FFFFF);
  /* Configure Bank3 type */
  FLASH->B3SEL = 2;
  /* Unlock the Bank3 program erase controller */  
  while (BIT_READ(FLASH->STS3, FLASH_STS_BSY));
  FLASH->FCKEY3 = 0x45670123;
  FLASH->FCKEY3 = 0xCDEF89AB;
  while (BIT_READ(FLASH->CTRL3, FLASH_CTRL_LCK));
  /* If the data written to Bank3 need to be scrambled, please specify the scrambled range */
  FLASH->DA = (0x00000000);
  return;
}
#endif
...
/**
  ...
  *
  *         (*) HSI_VALUE is a constant defined in scm4xx.h file (default value
  *             8 MHz) but the real value may vary depending on the variations
  *             in voltage and temperature.
  *
  *         (**) HSE_VALUE is a constant defined in scm4xx.h file (default value
...
/**
  * @brief  Setup the external memory controller. Called in startup_scm4xx.s
...
/**
  ...
  *         Called in startup_scm4xx_xx.s/.c before jump to main.
  * 	      This function configures the external SRAM mounted
  *         (SCM High density devices). This SRAM will be used as program
...
static void SetSysClockTo180M(void)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    /*  PLL configuration: PLLCLK = HSE/2 * 45 = 180 MHz */
    RCC->CFG &= RCC_CFG_PLLCFG_MASK;
    RCC->CFG |= (uint32_t)(RCC_CFG_PLLRC_HSE | RCC_CFG_PLLHSEPSC_HSE_DIV2 | RCC_CFG_PLLMULT45 | RCC_CFG_PLLRANGE_GT72MHZ);
...
#elif defined SYSCLK_FREQ_180MHz_HSI
/**
  * @brief  Sets System clock frequency to 180MHz from HSI and configure HCLK, PCLK2
  *         and PCLK1 prescalers.
  * @note   This function should be used only after reset.
  * @param  None
  * @retval None
...
static void SetSysClockTo180MHSI(void)
{
  ...
  if (HSIStatus == (uint32_t)0x01)
  {
    ...
    /*  PLL configuration: PLLCLK = (HSI/2) * 45 = 180 MHz */
    RCC->CFG &= RCC_CFG_PLLCFG_MASK;
    RCC->CFG |= (uint32_t)(RCC_CFG_PLLRC_HSI_DIV2 | RCC_CFG_PLLMULT45 | RCC_CFG_PLLRANGE_GT72MHZ);
